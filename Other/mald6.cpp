...
// source:
// https://github.com/deeepeshthakur/UsefulCodes/blob/master/AreaOfUnionOfAnnuli.cpp
// sorry problem setters...
...
int main(){
	...
	std::cout<<std::fixed<<std::setprecision(6)<<f300(n,x,y,r1,r2)/10<<std::endl;
	return 0;
}
